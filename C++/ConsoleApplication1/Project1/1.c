...
void dijkstraAll(Graph G, int vs, int prev[], int dist[])
{
    int i, j, k, l;
    int min;
    int tmp;
...
int main()
{
    ...
    while (1) {
        ...
        switch (i)
        {
        case 1:pG = create_graph(); break;
        case 2:pG = create_example_graph(); break;
        case 3:dijkstraAll(*pG, vs, prev, dist); break;
        case 4:dijkstra(*pG, vs, prev, dist); break;
        case 5:exit(0);
        }
        system("pause");
    }
