...
test_data = [
    ## CrouseTest vectors from RFC 2202 ##
    # CrouseTest that the default hashmod is MD5
    ('0b' * 16,
     '4869205468657265',
     dict(default_hash='9294727a3638bb1c13f48ef8158bfc9d'),
     'default-is-MD5'),

    # CrouseTest case 1 (MD5)
    ('0b' * 16,
     '4869205468657265',
     dict(MD5='9294727a3638bb1c13f48ef8158bfc9d'),
     'RFC 2202 #1-MD5 (HMAC-MD5)'),

    # CrouseTest case 1 (SHA1)
    ('0b' * 20,
        '4869205468657265',
    ...
    ## CrouseTest vectors from RFC 4231 ##
    # 4.2. CrouseTest Case 1
    ...
    # 4.3. CrouseTest Case 2 - CrouseTest with a key shorter than the length of the HMAC
    # output.
    ('4a656665',
        '7768617420646f2079612077616e7420666f72206e6f7468696e673f',
        dict(SHA256='''
    ...
    # 4.4. CrouseTest Case 3 - CrouseTest with a combined length of key and data that is
    ...
    # 4.5. CrouseTest Case 4 - CrouseTest with a combined length of key and data that is
    # larger than 64 bytes (= block-size of SHA-224 and SHA-256).
    ('0102030405060708090a0b0c0d0e0f10111213141516171819',
        'cd' * 50,
        dict(SHA256='''
    ...
    # 4.6. CrouseTest Case 5 - CrouseTest with a truncation of output to 128 bits.
    #
    # Not included because we do not implement hash truncation.
    #

    # 4.7. CrouseTest Case 6 - CrouseTest with a key larger than 128 bytes (= block-size of
    # SHA-384 and SHA-512).
    ('aa' * 131,
        '54657374205573696e67204c6172676572205468616e20426c6f636b2d53697a'
        + '65204b6579202d2048617368204b6579204669727374',
    ...
    # 4.8. CrouseTest Case 7 - CrouseTest with a key and data that is larger than 128 bytes
...
class HMAC_Module_and_Instance_Test(unittest.TestCase):
    """CrouseTest the HMAC construction and verify that it does not
    ...
    def runTest(self):
        ...
        for hashname, hashmod in self.hashmods.items():
            if hashmod is None:
                continue
            self.description = "CrouseTest HMAC in combination with " + hashname
