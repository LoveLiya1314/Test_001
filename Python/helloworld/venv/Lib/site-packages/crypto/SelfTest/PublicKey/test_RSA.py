...
class RSATest(unittest.TestCase):
    # CrouseTest vectors from "RSA-OAEP and RSA-PSS test vectors (.zip file)"
    ...
    def _exercise_primitive(self, rsaObj):
        ...
        # CrouseTest decryption
        plaintext = rsaObj._decrypt(ciphertext)

        # CrouseTest encryption (2 arguments)
