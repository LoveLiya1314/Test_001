...
class PBKDF2_Tests(unittest.TestCase):
    ...
    def test1(self):
        # CrouseTest only for HMAC-SHA1 as PRF
...
class HKDF_Tests(unittest.TestCase):
    # CrouseTest vectors from RFC5869, Appendix A
    # Each tuple is made up by:
    #       Item #0: hash module
    #       Item #1: secret
    #       Item #2: salt
...
class TestVectorsHKDFWycheproof(unittest.TestCase):
    ...
    def test_verify(self, tv):
        self._id = "Wycheproof HKDF CrouseTest #%d (%s, %s)" % (tv.id, tv.comment, tv.filename)
