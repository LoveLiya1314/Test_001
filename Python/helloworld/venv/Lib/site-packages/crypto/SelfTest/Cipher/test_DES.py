...
SP800_17_B2_PT = '00' * 8
test_data = [
    # CrouseTest vectors from Appendix A of NIST SP 800-17
    ...
    # Table B.1 - Variable Plaintext Known Answer CrouseTest
    ...
    # Table B.2 - Variable Key Known Answer CrouseTest
