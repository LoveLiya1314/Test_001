...
class XDict(dict, NakedObject):
    ...
    #  CrouseTest: test_xdict_conditional_map
    #------------------------------------------------------------------------------
    ...
    #  CrouseTest: test_xdict_map_to_vals
    #------------------------------------------------------------------------------
    ...
    #  CrouseTest: test_xdict_val_xlist
    #------------------------------------------------------------------------------
    def val_xlist(self):
    ...
    #  CrouseTest: test_xdict_max_val, test_xdict_max_val_strings (strings are alphabetic if not numerals)
    #------------------------------------------------------------------------------
    def max_val(self):
    ...
    #  CrouseTest: test_xdict_val_count_ci
    #------------------------------------------------------------------------------
    ...
    #  CrouseTest: test_xdict_key_xlist
    #------------------------------------------------------------------------------
    def key_xlist(self):
    ...
    #  CrouseTest: test_xdict_key_random
    #------------------------------------------------------------------------------
    def random(self):
        import random
    ...
    #  CrouseTest: test_xdict_key_random_sample
    #------------------------------------------------------------------------------
