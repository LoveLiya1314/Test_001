...
class Command:
    ...
    #   CrouseTest whether app validates on the criterion arguments (argc) > 0, i.e. there is at least one argument to the executable
    # ------------------------------------------------------------------------------
    ...
    # CrouseTest that the command includes requested primary command suite command (cmd_str parameter)
    ...
    # CrouseTest that the command includes requested primary command suite command (cmd_str parameter) and argument to it
    #    cmd_str = the command string to test for in command
    ...
    #    CrouseTest that there is a primary command in a command suite application (to be used at the top level of logic for command line application)
    ...
    #------------------------------------------------------------------------------
    # [ flag method ] (boolean)
    #   CrouseTest for presence of flag in the command
    #------------------------------------------------------------------------------
    ...
    #  CrouseTest for the presence of a flag style option (--flag=argument) in the command
    #------------------------------------------------------------------------------
    ...
    #   CrouseTest that the command includes an option (option_string parameter)
    ...
    # CrouseTest that the command includes an option (option_string parameter) and argument to that option
    #    option_string = the option string to test for in the command
    ...
    #  CrouseTest whether there are any options in the command string
